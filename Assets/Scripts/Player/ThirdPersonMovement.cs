...
public class ThirdPersonMovement : NetworkBehaviour
{
    ...
    public void Hitted(PlayerRef player)
    {
        Rpc_Hitted(player);
    }
    
    [Rpc]
    public void Rpc_Hitted([RpcTarget]PlayerRef player)
    {
        Instance.GetDamage(20);
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Hitted(other.gameObject.GetComponent<ThirdPersonMovement>().Object.StateAuthority);
        }
    }
}
